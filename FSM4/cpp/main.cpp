...
GEN_TEST_HSI(Mutant29);
GEN_TEST_HSI(Mutant30);
...
GEN_TEST_TOUR(Mutant29);
GEN_TEST_TOUR(Mutant30);
...
int main() {
    ...
    RUN_TEST(tr, HSITestMutant29);
    RUN_TEST(tr, HSITestMutant30);
    ...
    RUN_TEST(tr, TourTestMutant29);
    RUN_TEST(tr, TourTestMutant30);
